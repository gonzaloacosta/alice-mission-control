...
const INITIAL_PROJECTS: Project[] = [
  {
    id: 'kubiverse',
    name: 'KUBIVERSE',
    description: 'K8s Universe — Cluster Visualization',
    color: '#9ece6a',
    emissiveColor: '#9ece6a',
    progress: 0.55,
    version: 'v0.1.0',
    status: 'building',
    orbitRadius: 14,
    ...
    size: 1.8,
    startAngle: 0,
    tasks: { done: 8, total: 15 },
    agents: [
      { id: 'kubi-backend', name: 'Backend', role: 'Go API & Discovery', state: 'active', task: 'Edge API & auto-discovery', contribution: 0.7 },
